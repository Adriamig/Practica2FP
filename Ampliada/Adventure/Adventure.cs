    ...
    class MainClass
    {
        ...
        static bool HandleInput(string com, Player p, Map m, out bool quit)
        {
            ...
            switch (com)
            {
                ...
                case "go north":
                case "go n":
                    if (p.Move(m, Direction.North)) InfoPlace(m, p.GetPosition());
                    else
                    {
                        Console.ForegroundColor = ConsoleColor.Yellow;
                ...
                case "go south":
                case "go s":
                    if (p.Move(m, Direction.South)) InfoPlace(m, p.GetPosition());
                    else
                    {
                        Console.ForegroundColor = ConsoleColor.Yellow;
                        Console.WriteLine("You can't choose this direction.");
                ...
                case "go east":
                case "go e":
                    if (p.Move(m, Direction.East)) InfoPlace(m, p.GetPosition());
                    else
                    {
                        Console.ForegroundColor = ConsoleColor.Yellow;
                        Console.WriteLine("You can't choose this direction.");
                ...
                case "go West":
                case "go w":
                    if (p.Move(m, Direction.West)) InfoPlace(m, p.GetPosition());
                    else
                    {
                        Console.ForegroundColor = ConsoleColor.Yellow;
                        Console.WriteLine("You can't choose this direction.");
        ...
        // Metodo que escribe en pantalla la informacion de la sala
        ...
        // Metodo para saber si el jugador se encuentra en la salida
        static bool ArrivedAtExit(Map m, Player thePlayer)
        {
            // Devuelve true en el caso de que se encuentre en la salida
            return m.IsExit(thePlayer.GetPosition());
        }

        // Metodo que he implementado para escribir los comandos en forma de tabla
